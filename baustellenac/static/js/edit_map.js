...
$.fn.sites = function(opts) {
  var default_lat, default_lng, drawControl, drawnItems, icon, icon_default, icon_sidewalk, init, init_edit_map, init_icon, init_static_map, map, map_attribution, map_url, map_zoom, marker, max_zoom, mode, set_marker, set_marker_latlng_to_form, set_static_marker, set_static_polyline, smarker, spolyline, staticmap;
  if (opts == null) {
    opts = {};
  }
  mode = 'marker';
  ...
  init_edit_map = function() {
    ...
    if (mode === 'route') {
      ...
      return map.on('draw:created', function(e) {
        ...
        return set_static_polyline(layer._latlngs);
      });
    }
  };
