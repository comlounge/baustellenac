...
$.fn.sites = function(opts) {
  var cloudmate_api_key, create_infomodal, init, make_infopopup, make_marker, make_route, map, map_attribution, map_url, map_zoom, markers, max_zoom, show_infomodal;
  if (opts == null) {
    opts = {};
  }
  map_zoom = 13;
