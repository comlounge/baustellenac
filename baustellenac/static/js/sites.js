...
$.fn.sites = function(opts) {
  ...
  create_infomodal = function(data) {
    var approx_time, body, city, city_names, desc, end_date, end_time, m, organisation, site, start_date, start_time, subtitle;
    site = data['site'];
    city_names = data['city_names'];
    m = $('#infomodal');
    m.find('.modal-header h3').html(site['name']);
    body = "";
    subtitle = $('<div class="row"></div>').append('<div class="span2">Untertitel</div>').append('<div class="span4">' + site['subtitle'] + '</div>');
    desc = $('<div class="row"></div>').append('<div class="span2">Beschreibung</div>').append('<div class="span4">' + site['description'] + '</div>');
    city = $('<div class="row"></div>').append('<div class="span2">Stadt</div>').append('<div class="span4">' + city_names[site['city']] + '</div>');
    organisation = $('<div class="row"></div>').append('<div class="span2">Träger</div>').append('<div class="span4">' + site['organisation'] + '</div>');
    approx_time = $('<div class="row"></div>').append('<div class="span2">Vorr. Zeitrahmen</div>').append('<div class="span4">' + site['approx_timeframe'] + '</div>');
