...
$.fn.sites = function(opts) {
  var create_infomodal, icon_default, icon_sidewalk, init, make_infopopup, make_marker, make_route, map, map_attribution, map_url, map_zoom, markers, max_zoom, onLocationFound, polyline, show_infomodal, show_polyline;
  if (opts == null) {
    opts = {};
  }
  map_zoom = 13;
